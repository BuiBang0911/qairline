...
public class PromotionController {
    ...
    @GetMapping("api/getPromotionOn")
    @ResponseBody
    public List<PromotionResponse> getPromotionOn(@RequestHeader("Authorization") String authorizationHeader) {
        if (!authController.isTokenBlacklisted(authorizationHeader)) {
            return promotionService.getPromotionOn();
        }
        return null;
    }
